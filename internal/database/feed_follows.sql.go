...
const deleteFeedFollowsByUserAndUrl = `-- name: DeleteFeedFollowsByUserAndUrl :exec
...
func (q *Queries) DeleteFeedFollowsByUserAndUrl(ctx context.Context, arg DeleteFeedFollowsByUserAndUrlParams) error {
	_, err := q.db.ExecContext(ctx, deleteFeedFollowsByUserAndUrl, arg.UserID, arg.FeedID)
	return err
}
